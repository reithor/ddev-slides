...
```hint
For PHPStorm setup, please refer to the instructions you received via email.
```
...
namespace Ibexa\Bundle\Core\DependencyInjection;ibexa:
```
...
- About
    - Who is Ibexa?
    - Why use a solution from Ibexa?
- Overview of Ibexa DXP, formely eZ Platform _(Theory)_
    - Key features
    - Understanding the content model
- Hands on training _(Practice)_
    - Content Architecture
    - Developing a website/app from a-z
- Bonus: Look to additional features _(As time permits)_
...
<img class="scale70 center" src="_common/images/about_ibexa.png" alt="About Ibexa" />

_<center>20 years delivering powerfull enterprise CMS, now a full fledge DXP!</center>_
...
Note:
- TL:DR; Allows to have settings per siteaccess, and also group settings
